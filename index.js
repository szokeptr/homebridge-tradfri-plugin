...
var _platform = __webpack_require__(302);
...
var exec = __webpack_require__(303).exec;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(85), __webpack_require__(300)(module), __webpack_require__(298)))
...
var TradfriAccessory = function () {
  ...
  _createClass(TradfriAccessory, [{
    ...
    value: function getServices() {
      ...
      accessoryInfo.setCharacteristic(Characteristic.Name, this.device.name).setCharacteristic(Characteristic.Manufacturer, this.device.manufacturer).setCharacteristic(Characteristic.Model, "Lamp");

      var lightbulbService = new this.platform.bridge.Service.Lightbulb(this.device.name);
...
var _device = __webpack_require__(301);

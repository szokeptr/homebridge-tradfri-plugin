...
exports.default = function (homebridgeInstance) {
    ...
    homebridgeInstance.registerPlatform('homebridge-tradfri', 'IkeaTradfri', _platform.TradfriPlatform, true);
};
...
var _commandExists = __webpack_require__(132);
...
var child_process = __webpack_require__(90);
...
var _Coap = __webpack_require__(127);

var _Coap2 = _interopRequireDefault(_Coap);

var _device = __webpack_require__(129);
...
var TradfriPlatform = exports.TradfriPlatform = function () {
    function TradfriPlatform(log, config, api) {
        var _this = this;
    ...
    _createClass(TradfriPlatform, [{
        ...
        value: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(device) {
                var platform, uuid, newAccessory;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                newAccessory = new Accessory(device.device.name, uuid);
                                ...
                                _context.next = 12;
                                return this.api.registerPlatformAccessories("homebridge-tradfri", "IkeaTradfri", [newAccessory]);
        ...
        key: 'removeAccessory',
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(accessory) {
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                _context2.next = 3;
                                return this.api.unregisterPlatformAccessories("homebridge-tradfri", "IkeaTradfri", accessory);
        ...
        value: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
                ...
                var ids, knownAccessories, newIds, _loop, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, deviceId;
                        ...
                        switch (_context5.prev = _context5.next) {
                            ...
                            case 16:
                                ...
                                if (_context5.t1.signal === 'SIGTERM') {
                                    this.log('Command timed out: ' + _context5.t1.cmd);
                                } else {
                                ...
                                this.accessories.forEach(function () {
                                    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(accessory) {
                            ...
                            case 22:
                                ...
                                ids.forEach(function (id) {
                                    var index = knownAccessories.findIndex(function (accessory) {
                                        return accessory.context.deviceId === id;
                                    });
                                    if (index === -1) {
                                        newIds.push(id);
                                    } else {
                                ...
                                _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop(deviceId) {
                                    var device, tdevice, accessory, _tdevice, service, _accessory;
                                        ...
                                        while (1) {
                                            switch (_context4.prev = _context4.next) {
                                                case 0:
                                                    _context4.prev = 0;
                                                    _context4.next = 3;
                                                    return _this2.coap.get('15001/' + deviceId);
                                                ...
                                                case 3:
                                                    ...
                                                    tdevice = new _device2.default(device, _this2, _this2.log);

                                                    _this2.log('Adding new device to homekit', deviceId);
                                                    _this2.addAccessory(tdevice);
                                                    _context4.next = 34;
                                                    break;

                                                case 11:
                                                    accessory = _this2.accessories.find(function (accessory) {
                                                        return accessory.context.deviceId === deviceId;
                                                    });
                                                    ...
                                                    _context4.prev = 14;
                                                    _tdevice = new _device2.default(device, _this2, _this2.log);
                                                    service = accessory.getService(_tdevice.device.name);
                                                    _context4.next = 19;
                                                    return accessory.removeService(service);

                                                case 19:
                                                    _context4.next = 21;
                                                    return accessory.addService(_tdevice.getServices()[1]);
                                                ...
                                                case 24:
                                                    ...
                                                    _this2.log.error("Problem updating device, removing it", _context4.t0);
                                                    _context4.next = 29;
                                                    return _this2.api.unregisterPlatformAccessories("homebridge-tradfri", "IkeaTradfri", [accessory]);

                                                case 29:
                                                    _context4.next = 31;
                                                    return accessory.updateReachability(true);
                                                ...
                                                case 33:
                                                    _this2.log.error("Code error", deviceId, "not found in accessories");
                                                ...
                                                case 36:
                                                    ...
                                                    _this2.log.error("Caught exception", _context4.t1);

                                                    if (_context4.t1.signal === 'SIGTERM') {
                                                        _this2.log.error('Command timed out: ' + _context4.t1.cmd);
                                                    }
                                                    _accessory = _this2.accessories.find(function (accessory) {
                                                        return accessory.context.deviceId === deviceId;
                                                    });

                                                    if (_accessory) {
                                                        _accessory.updateReachability(false);
                                                        _accessory.context.noServiceConfigured = true;
                                                    }
...
var exec = __webpack_require__(90).exec;
var execSync = __webpack_require__(90).execSync;
